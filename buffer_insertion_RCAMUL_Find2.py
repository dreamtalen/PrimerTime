...
def main_progress():
    ...
    rca_stage_dff_list = ['ICI','I214', 'I215', 'I216', 'I217', 'I218', 'I219', 'I220', 'I221', 'I230', 'I231', 'I232', 'I233', 'I234', 'I235', 'I236', 'I237']
    ...
    rca_num = int(input_file[8])
    for i in range(rca_num):
        startportlist_list.append(['rca_8bit_'+str(i+1)+'_'+dff+'_port_CP' for dff in rca_stage_dff_list])
        endportlist_list.append(['rca_8bit_'+str(i+1)+'_'+dff+'_port_D' for dff in rca_stage_dff_list])
    ...
    for factor in [x/10000.0 for x in range(low_factor, high_factor)]:
        area_list = []
        time_list = []
        edge_delay_dict = dict.copy(edge_delay_dict_bak)
        path_latency_dict = dict.copy(path_latency_dict_bak)
