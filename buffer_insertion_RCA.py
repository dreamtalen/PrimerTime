...
def main_progress():
    ...
    stage_dff_list = ['ICI','I214', 'I215', 'I216', 'I217', 'I218', 'I219', 'I220', 'I221', 'I230', 'I231', 'I232', 'I233', 'I234', 'I235', 'I236', 'I237']

    startportlist_list = []
    endportlist_list = []
    startportlist_list.append(list(set(module_input_port_list)))
    # rca_num = int(input_file[3])
    rca_num = 10
    for i in range(rca_num):
        startportlist_list.append(['rca_8bit_'+str(i+1)+'_'+dff+'_port_CP' for dff in stage_dff_list])
        endportlist_list.append(['rca_8bit_'+str(i+1)+'_'+dff+'_port_D' for dff in stage_dff_list])
