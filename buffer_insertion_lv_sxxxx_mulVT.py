...
def main_progress():
    ...
    module_wire_dict, module_port_arg_dict, module_design_dict, module_list, wire_list, raw_input_list, raw_output_list = ast_parser("s35932.ast")
    port_list = []
    port_wire_dict = {}
    port_design_dict = {}
    port_attr_dict = {}
    ...
    print "Time acceleration", 1.0 - new_time/original_time
    print "Area exceed", new_area/original_area - 1.0
