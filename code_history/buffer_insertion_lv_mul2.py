...
def main_progress():
    ...
    module_wire_dict, module_port_arg_dict, module_design_dict, module_list, wire_list, raw_input_list, raw_output_list = ast_parser("multiplier2.ast")
    port_list = []
    port_wire_dict = {}
    port_design_dict = {}
    port_attr_dict = {}
    ...
    second_stage_dff_list = ['I1932', 'I1931', 'I1912', 'I1911', 'I1952', 'I1951', 'I1972', 'I1971', 'I1992', 'I1991', 'I2012', 'I2011']
    # first_stage_dff_start_port_list = [i+'_port_CP' for i in first_stage_dff_list]

    port1_list = list(set(module_input_port_list))
    port2_endpoint_list = ['multiplier_1_'+i+'_port_D' for i in first_stage_dff_list]
    port2_startpoint_list = ['multiplier_1_'+i+'_port_CP' for i in first_stage_dff_list]
    port3_endpoint_list = ['multiplier_1_'+i+'_port_D' for i in second_stage_dff_list]
    port3_startpoint_list = ['multiplier_1_'+i+'_port_CP' for i in second_stage_dff_list]
    port4_endpoint_list = ['multiplier_2_'+i+'_port_D' for i in first_stage_dff_list]
    port4_startpoint_list = ['multiplier_2_'+i+'_port_CP' for i in first_stage_dff_list]
    port5_endpoint_list = ['multiplier_2_'+i+'_port_D' for i in second_stage_dff_list]
    port5_startpoint_list = ['multiplier_2_'+i+'_port_CP' for i in second_stage_dff_list]
    port6_list = list(set(module_output_port_list))

    startportlist_list = [port1_list,port2_startpoint_list,port3_startpoint_list,port4_startpoint_list,port5_startpoint_list]
    endportlist_list = [port2_endpoint_list,port3_endpoint_list,port4_endpoint_list,port5_endpoint_list,port6_list]

    # paths = find_all_paths(directed_graph, 'multiplier_1_I215_port_CP','multiplier_1_I2012_port_D' , D_port_list)
    part_path_list_list = []
    ...
    print "Area exceed", sum(area_list)/original_area - 1.0
